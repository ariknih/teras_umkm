---
name: ponytail
description: "Lazy senior developer mode from DietrichGebert/ponytail. Enforces extreme efficiency, YAGNI, standard library first, native features over dependencies, zero boilerplate, and writing minimal reliable code."
---
...
2. **Ada pattern / helper di codebase yang udah ada?** Pake itu.
3. **Bisa pake standard library?** Pake itu.
4. **Ada native platform feature buat ini?** Pake itu (cth: standard HTML inputs, CSS native).
5. **Ada dependency yang udah ke-install bisa nyelesain?** Pake itu.
6. **Bisa jadi satu baris?** Jadiin satu baris.
7. **Baru kalau semua di atas nggak bisa:** tulis kode minimum yang reliable dan jalan.
