      ...
      {activeTab === 'MARKETPLACE' ? (
        ...
        <div className="space-y-4 pt-1">
          ...
          {filteredProducts.length === 0 ? (
            ...
            <>
              {/* Product Cards Grid: 5 Rows (30 items on 6-col desktop) */}
              ...
              {filteredProducts.length > visibleProductCount && (
                <div className="flex flex-col items-center justify-center pt-8 pb-4 gap-2.5">
                  <button
                    onClick={() => setVisibleProductCount((prev) => prev + 18)}
                    className="px-8 py-3.5 bg-white hover:bg-emerald-50 text-[#006E24] border-2 border-[#006E24] rounded-2xl font-extrabold text-sm transition-all shadow-xs hover:shadow-md flex items-center gap-2.5 cursor-pointer group"
                  >
