        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-10 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16" suppressHydrationWarning>
          ...
          <div className="space-y-3" suppressHydrationWarning>
            ...
            <nav className="flex flex-col gap-2.5">
              <Link href="/market" className="text-xs text-slate-500 hover:text-primary transition-colors font-medium">Marketplace</Link>
              <Link href="/jasa" className="text-xs text-slate-500 hover:text-primary transition-colors font-medium">Booking Jasa & Keahlian</Link>
              <Link href="/community" className="text-xs text-slate-500 hover:text-primary transition-colors font-medium">Community</Link>
              <Link href="/affiliate" className="text-xs text-slate-500 hover:text-primary transition-colors font-medium">Affiliate Hub</Link>
              <Link href="/academy" className="text-xs text-slate-500 hover:text-primary transition-colors font-medium">Saloka Academy</Link>
            </nav>
          </div>
