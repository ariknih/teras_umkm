  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] pt-24 pb-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1100px] mx-auto space-y-6">
        ...
        {/* ── HEADER BANNER ── */}
        <div className="bg-gradient-to-r from-emerald-950 via-[#006E24] to-[#0A4D1A] rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-white shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="bg-white border border-slate-200/90 rounded-2xl p-2 sm:p-3 shadow-xs flex items-center gap-2 overflow-x-auto">
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all cursor-pointer ${
              activeCategory === 'ALL'
                ? 'bg-[#006E24] text-white shadow-2xs font-extrabold'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {filteredVouchers.map((v) => {
            ...
            return (
              ...
              >
                {/* Top Badge Strip */}
                <div className={`p-4 ${isOngkir ? 'bg-emerald-50 text-[#006E24]' : 'bg-amber-50 text-amber-900'} border-b border-slate-100 flex items-center justify-between`}>
                  <div className="flex items-center gap-2">
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center font-bold text-sm ${isOngkir ? 'bg-[#006E24] text-white' : 'bg-amber-500 text-white'}`}>
                ...
                <div className="p-4 space-y-3">
                  <div>
                    <h3 className="font-extrabold text-xs sm:text-sm text-slate-900 line-clamp-1 group-hover:text-[#006E24] transition-colors">
                      {v.title}
                    </h3>
                ...
                <div className="p-4 pt-0">
                  <Link
                    ...
                    className="w-full py-2.5 bg-[#006E24] hover:bg-[#084e1b] text-white text-xs font-extrabold rounded-xl transition-all shadow-2xs flex items-center justify-center gap-1.5"
                  >
        ...
        <div className="bg-white border border-slate-200/90 rounded-2xl p-5 sm:p-6 shadow-xs space-y-3">
          <h4 className="text-xs sm:text-sm font-extrabold text-slate-900 flex items-center gap-2">
            <ShieldCheck size={16} className="text-[#006E24]" />
