          ...
          <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            ...
            >
              ...
              {paymentSuccess ? (
                ...
                <div className="p-3 bg-slate-50 border border-gray-150 rounded-2xl text-center">
                  <span className="text-[10px] text-gray-500 font-medium leading-relaxed">
                    Anda akan diarahkan ke halaman pembayaran (QRIS, Transfer Bank, atau Kartu) untuk menyelesaikan pembayaran secara aman.
                  </span>
                </div>
