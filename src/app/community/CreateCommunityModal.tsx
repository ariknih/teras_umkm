...
interface CreateCommunityModalProps {
  ...
  onClose: () => void
  user: any
  requiresKycToCreate: boolean
  onCreated: () => void
}

export default function CreateCommunityModal({ open, onClose, user, requiresKycToCreate, onCreated }: CreateCommunityModalProps) {
  ...
  const handleFileUpload = async (file: File, kind: 'avatar' | 'cover') => {
    ...
    try {
      ...
      setUrl(data.url)
      goeyToast.success(`Foto ${kind === 'avatar' ? 'Logo' : 'Sampul'} berhasil diunggah!`)
    } catch (e: any) {
      console.error(e)
            ...
            {requiresKycToCreate ? (
              <div className="space-y-6">
                <div className="flex justify-between items-center border-b border-black/5 pb-3">
                  ...
                  <button onClick={() => { onClose(); setModalStep('FORM') }} className="text-text-secondary hover:text-[#111111] text-sm font-bold">✕</button>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  ...
                  <button onClick={() => { onClose(); setModalStep('FORM') }} className="text-gray-400 hover:text-gray-700 text-sm font-bold">✕</button>
                </div>
