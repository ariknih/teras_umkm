...
function AuthContent() {
  ...
  return (
    <div className="w-full max-w-[420px] z-10 flex flex-col items-center mx-auto bg-surface border border-outline-variant rounded-xl p-6 sm:p-8 auth-card-shadow">
      {/* Brand Header */}
